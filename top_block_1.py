...
# Title: Top Block
# Generated: Tue Apr 16 13:37:40 2019
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(1, firdes.low_pass(
        	1, samp_rate, slider_cutoff, slider_trans, firdes.WIN_HAMMING, 6.76))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.slider_cutoff, self.slider_trans, firdes.WIN_HAMMING, 6.76))
